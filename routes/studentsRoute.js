...
const { renderAddStudentsDetails, AddStudentsDetails, renderRegisterPage, RegisterPage, renderSingleStudentDetails, renderUpdateStudentsDetails, renderDeleteStudentsDetails, renderLoginPage, renderAllDetails, renderLogoutPage, renderHomePage, LoginPage, UpdateStudentsDetails } = require("../controller/studentsDetails/studentController");
